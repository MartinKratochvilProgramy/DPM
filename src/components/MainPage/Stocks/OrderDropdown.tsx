...
export const OrderDropDown: React.FC<Props> = ({
  ...
  const themeStyles =
    theme === 'light'
      ? 'text-black bg-white bg-gray-100'
      : 'text-white bg-blue-600 hover:bg-blue-700 hover:text-white active:bg-blue-800';
  ...
  return (
    ...
    >
      ...
      >
        <ul
          className="text-[12px] xsm:text-xs text-gray-700"
