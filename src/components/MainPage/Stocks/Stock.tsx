...
export const Stock: React.FC<Props> = ({ stock, deleteStock }) => {
  ...
  function openDeleteStockModal (amountTodelete: number) {
    setDeleteAmount(amountTodelete)
    ...
    <>
      ...
      >
        <div className="flex flex-row items-center">
          ...
          <div onClick={() => { openDeleteStockModal(stock.amount) }} id={stock.ticker} className="rounded-full p-1 transition duration-150 hover:bg-red-100 ease-in-out">
