      ...
      >
        <div className="flex flex-row w-full items-center justify-between mb-1">
          <div className='flex flex-row justify-start sm:justify-start w-full max-w-[400px] px-1 dark:text-gray-100'>
            <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-start">{stock.ticker}</div>
            <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-center">{stock.amount}</div>
            <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-center">{stock.prevClose.toFixed(2)}</div>
            <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-center">
        ...
        {expanded &&
            <div className="flex flex-col items-start justify-start border-t-[1px] border-t-gray-300 dark:border-t-gray-500 space-y-2">
              <div className="flex flex-row justify-start sm:justify-start w-full max-w-[400px] mt-4 px-1 dark:text-gray-100">
                <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-start font-bold">DATE</div>
                <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-center font-bold">AMOUNT</div>
                <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-center font-bold">PRICE</div>
                <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex justify-center font-bold">CHANGE</div>
              </div>
                ...
                return (
                  <div key={purchase.id} className="flex flex-row w-full justify-start sm:justify-between items-center rounded-2xl px-1 py-1 hover:bg-gray-100 dark:hover:bg-opacity-5 mr-1">
                    <div className="flex flex-row w-full max-w-[400px] px-1 justify-start sm:justify-start rounded-xl h-full">
                      <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex items-center justify-start">{day}-{month}-{year}</div>
                      <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex items-center justify-center">{purchase.amount}</div>
                      <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex items-center justify-center">{purchase.price}</div>
                      <div className="w-[40px] sm:w-[50px] md:w-[60px] xl:w-[64px] 2xl:w-[78px] flex items-center justify-center">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke={theme === 'light' ? 'black' : 'white'} className="w-3 md:w-6 h-3 md:h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                      </svg>
                    </div>
                  </div>
