...
const StockChartModal: React.FC<Props> = ({
  stockTicker,
  purchaseHistory,
  stockHistory,
  loadingData,
  ...
  const [chartTheme, setChartTheme] = useState(
    theme === 'light' ? chartThemeLight : chartThemeDark,
  );
          ...
          {loadingData ? (
            ...
            <>
              {stockChartLoadingError.length > 0 ? (
                ...
                >
                  <h2 className="playfair mt-4 mb-4 text-2xl lg:text-3xl text-gray-800 dark:text-gray-100">
                    {stockTicker}
                  </h2>
