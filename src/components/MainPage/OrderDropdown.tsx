  ...
  return (
    <>
      <button
        ...
        className={`relative flex flex-row min-w-[100px] justify-center items-center py-1 px-3 font-medium text-[12px] xsm:text-xs leading-snug rounded whitespace-nowrap shadow-md hover:shadow-xl transition duration-150 ease-in-out ${themeStyles}`}
        type="button">
        {dropdownState}
        <svg
