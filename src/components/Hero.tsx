...
const Hero = () => (
	<div className='min-h-auto lg:min-h-[80vh]'>
		<Container className='flex flex-wrap'>
			<div className='flex items-center w-full lg:w-1/2'>
				<div className='max-w-2xl mb-8 mr-6'>
					...
					<div className='flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row'>
						<a
							...
							className='flex flex-row px-2 md:px-4 py-1 md:py-2 my-2 mr-1 text-gray-100 rounded border-solid border-blue-600 border-[1px] bg-blue-600 font-medium text-md leading-snug uppercase whitespace-nowrap shadow-md hover:bg-blue-700 hover:text-white hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-300 ease-in-out'>
							Create a Free Account
						</a>
						<a
							href=''
							rel='noopener noreferrer'
							className='flex flex-row px-2 md:px-4 py-1 md:py-2 my-2 mr-1 text-blue-600 rounded border-solid border-blue-600 border-[1px] bg-white font-medium dark:bg-transparent dark:hover:border-none dark:hover:text-gray-800 dark:hover:bg-gray-200 text-md leading-snug uppercase whitespace-nowrap shadow-md hover:bg-blue-700 hover:text-gray-200 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-300 ease-in-out'>
							Try Demo
						</a>
					</div>
				</div>
