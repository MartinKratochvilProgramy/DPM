...
const FeatureCard: React.FC<Feature> = ({ title, text }) => {
  return (
    <div className='border border-blue-500 dark:border-gray-600 rounded-3xl bg-white bg-opacity-[1] dark:bg-transparent p-2 sm:p-4 space-y-2 md:space-y-4 lg:space-y-6 hover:translate-y-[-2px] shadow-md hover:shadow-lg transition duration-300 ease-in-out'>
