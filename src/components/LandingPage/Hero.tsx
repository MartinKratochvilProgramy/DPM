      ...
      <div className="flex items-center w-full lg:w-8/12">
        <div className="flex flex-col w-full mb-8 mr-6">
          <h1 className="playfair text-5xl xl:text-6xl tracking-tight text-gray-800 leading-snug lg:leading-tight xl:leading-[66px] dark:text-gray-200">
            Simple Way to <span className=""> Manage</span> Your{' '}
            <span className="text-blue-600 paint-brush">Investments</span> Daily
          </h1>
          <p className="py-8 md:py-12 text-xl text-justify leading-normal text-gray-500 lg:text-xl dark:text-gray-300">
            Manage your investments all in one place for free. Whether
            you&apos;re a seasoned investor or just starting out, Daily
            Portfolio Management provides you with the tools and insights needed
            to navigate the world of stocks and take control of your financial
            destiny.
          </p>
